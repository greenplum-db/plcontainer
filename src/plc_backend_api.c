...
static PLC_FunctionEntriesData DockerBackend = {
        plc_docker_create_container,  plc_docker_start_container, plc_docker_kill_container,
        plc_docker_inspect_container, plc_docker_wait_container,  plc_docker_delete_container,
};

static PLC_FunctionEntriesData ProcessBackend = {
        plc_process_create_container,  plc_process_start_container, plc_process_kill_container,
        plc_process_inspect_container, plc_process_wait_container,  plc_process_delete_container,
};
...
void
plc_backend_prepareImplementation(enum PLC_BACKEND_TYPE imptype)
{
	/*
...
int
plc_backend_create(runtimeConfEntry *conf, char **name, int container_slot, char **uds_dir)
{
...
int
plc_backend_start(const char *name)
{
...
int
plc_backend_kill(const char *name)
{
...
int
plc_backend_inspect(const char *name, char **element, plcInspectionMode type)
{
...
int
plc_backend_wait(const char *name)
{
...
int
plc_backend_delete(const char *name)
{

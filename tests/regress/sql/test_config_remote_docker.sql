-- start_ignore
\! plcontainer runtime-add -r plc_python3_shared_remote_docker -i ${CONTAINER_NAME_SUFFIX_PYTHON} -l python3 -s enable_network=yes -s roles=$USER $(./data/auto_select_client.py -i "${CONTAINER_NAME_SUFFIX_PYTHON}")
